...
<nav class="w-100 navbar navbar-expand-lg navbar-light bg-light sticky-top shadow-sm" style="min-height:80px;">
  <div class="container-fluid">
    <a class="navbar-brand text-danger" href="index.php">
       ...
       <span >
       <div class="float-right mt-0 mt-md-2">
        <i class="fs-4" >karate focus</i>
       </div>
       </span> 
    </a>
...
<nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-danger " style="height: 100px;">
  <div class="container-fluid">
