  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Admin/Masters Data</h1>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
            ...
            <div class="card-body">
              <form class="container">
                <div class="row">
                  <div class="col-md-6">
                      <div class="mb-3">
                        <label for="formFile" class="form-label">Upload Admin Image</label>
                        <input class="form-control my-2" type="file" id="formFile1">
                        <input class="form-control my-2" type="file" id="formFile2">
                        <input class="form-control my-2" type="file" id="formFile3">
                      </div>
                      <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Admin Name</label>
                        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Input Admins Name">
                      </div>
                      <div class="mb-3">
                    ...
                    <div class="col-md-6">
                      <div class="mb-3">
                        <label for="exampleFormControlInput2" class="form-label">About Admin</label>
